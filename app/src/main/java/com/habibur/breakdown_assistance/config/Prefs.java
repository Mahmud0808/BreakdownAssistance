package com.habibur.breakdown_assistance.config;

import android.content.Context;
import android.content.SharedPreferences;

import com.habibur.breakdown_assistance.BreakdownAssistance;
import com.habibur.breakdown_assistance.BuildConfig;
...
public class Prefs {
    ...
    public static SharedPreferences prefs = BreakdownAssistance.getAppContext().createDeviceProtectedStorageContext().getSharedPreferences(BuildConfig.APPLICATION_ID, Context.MODE_PRIVATE);
